...
void RunBtnMenu::initMenu()
{
    ...
    //!!! Hard coded !!!
    QAction* menuAct_1 = new QAction(QIcon("/home/james/NetBeansProjects/ride/images/cpp.png"), "1.exe", this);
    menuAct_1->setCheckable(true);
    QAction* menuAct_2 = new QAction(QIcon("/home/james/NetBeansProjects/ride/images/run201.jpg"), "2.exe", this);
    menuAct_2->setCheckable(true);
    QAction* menuAct_3 = new QAction(QIcon("/home/james/NetBeansProjects/ride/images/run201.jpg"), "3.exe", this);
    ...
    QAction* menuAct_4 = new QAction(QIcon("/home/james/NetBeansProjects/ride/images/run201.jpg"), "1.exe", this);
    menuAct_4->setCheckable(true);
    QAction* menuAct_5 = new QAction(QIcon("/home/james/NetBeansProjects/ride/images/run201.jpg"), "2.exe", this);
    menuAct_5->setCheckable(true);
    QAction* menuAct_6 = new QAction(QIcon("/home/james/NetBeansProjects/ride/images/run201.jpg"), "3.exe", this);
    ...
    QAction* menuAct_7 = new QAction(QIcon("/home/james/NetBeansProjects/ride/images/run201.jpg"), "1.exe", this);
    QAction* menuAct_8 = new QAction(QIcon("/home/james/NetBeansProjects/ride/images/run201.jpg"), "2.exe", this);
    QAction* menuAct_9 = new QAction(QIcon("/home/james/NetBeansProjects/ride/images/run201.jpg"), "3.exe", this);
    QAction* menuAct_10 = new QAction(QIcon("/home/james/NetBeansProjects/ride/images/cpp.png"), "4.launch", this);
