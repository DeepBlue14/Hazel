...
void NewProjectGui::genRideProjDepends(QProcess* process, QString* projectRootStrPtr)
{
    ...
    //create build file
    QFile* buildFile = new QFile("./.rideProject/resources/project/scripts/build/build.bash");
    ...
    //create rosrun file
    QFile* runFile = new QFile("./.rideProject/resources/project/scripts/execute/run.bash");
