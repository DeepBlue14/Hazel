...
NewWorkspacePage_4::NewWorkspacePage_4(QWidget* parent) : QWidget(parent)
{
...
void NewWorkspacePage_4::handleAddToListBtnPtrSlot()
{
...
void NewWorkspacePage_4::handleRmFromListBtnPtrSlot()
{
...
QStringList* NewWorkspacePage_4::getDependsEnteredStrList()
{
    return dependsEnteredStrList;
}


QString* NewWorkspacePage_4::toString()
{
...
NewWorkspacePage_4::~NewWorkspacePage_4()
{
    ;
}
