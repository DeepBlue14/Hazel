#############################################################################
# Makefile for building: dist/Debug/GNU-Linux/rqt_plugins
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Jan 8 22:09:18 2016
...
QMAKE_TARGET  = rqt_plugins
DESTDIR       = dist/Debug/GNU-Linux/
TARGET        = dist/Debug/GNU-Linux/rqt_plugins
...
dist: 
	@$(CHK_DIR_EXISTS) build/Debug/GNU-Linux/rqt_plugins1.0.0 || $(MKDIR) build/Debug/GNU-Linux/rqt_plugins1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux/rqt_plugins1.0.0/ && $(COPY_FILE) --parents src/RideEnv.h src/RosEnv.h src/UnixConsoleText.h src/WindowsConsoleText.h build/Debug/GNU-Linux/rqt_plugins1.0.0/ && $(COPY_FILE) --parents src/RosEnv.cpp src/UnixConsoleText.cpp src/WindowsConsoleText.cpp src/main.cpp build/Debug/GNU-Linux/rqt_plugins1.0.0/ && (cd `dirname build/Debug/GNU-Linux/rqt_plugins1.0.0` && $(TAR) rqt_plugins1.0.0.tar rqt_plugins1.0.0 && $(COMPRESS) rqt_plugins1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux/rqt_plugins1.0.0`/rqt_plugins1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux/rqt_plugins1.0.0
