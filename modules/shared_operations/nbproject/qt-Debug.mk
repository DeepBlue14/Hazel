#############################################################################
# Makefile for building: dist/Debug/GNU-Linux/shared_operations
...
INCPATH       = -Inbproject -I. -I/opt/Qt/5.5/gcc_64/include -I/opt/Qt/5.5/gcc_64/include/QtWidgets -I/opt/Qt/5.5/gcc_64/include/QtGui -I/opt/Qt/5.5/gcc_64/include/QtCore -I. -I/opt/Qt/5.5/gcc_64/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = shared_operations1.0.0
DISTDIR = /home/james/NetBeansProjects/rqt_ide/modules/shared_operations/build/Debug/GNU-Linux/shared_operations1.0.0
LINK          = g++
...
SOURCES       = SharedOperations.cpp \
		main.cpp 
OBJECTS       = build/Debug/GNU-Linux/SharedOperations.o \
...
DIST          = /opt/Qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		nbproject/nbproject/qt-Debug.pro SharedOperations.h SharedOperations.cpp \
		main.cpp
QMAKE_TARGET  = shared_operations
DESTDIR       = dist/Debug/GNU-Linux/#avoid trailing-slash linebreak
TARGET        = dist/Debug/GNU-Linux/shared_operations
...
distdir: FORCE
	...
	$(COPY_FILE) --parents SharedOperations.h $(DISTDIR)/
	$(COPY_FILE) --parents SharedOperations.cpp main.cpp $(DISTDIR)/
...
build/Debug/GNU-Linux/SharedOperations.o: SharedOperations.cpp SharedOperations.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux/SharedOperations.o SharedOperations.cpp

build/Debug/GNU-Linux/main.o: main.cpp /opt/Qt/5.5/gcc_64/include/QtWidgets/QApplication \
