#############################################################################
# Makefile for building: dist/Debug/GNU-Linux/universal
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = universal1.0.0
DISTDIR = /home/james/NetBeansProjects/rqt_ide/modules/universal/build/Debug/GNU-Linux/universal1.0.0
LINK          = g++
...
SOURCES       = src/Env.cpp \
		src/OverriddenOperators.cpp \
		src/UnixConsoleText.cpp \
		src/WindowsConsoleText.cpp \
		src/main.cpp 
OBJECTS       = build/Debug/GNU-Linux/Env.o \
		build/Debug/GNU-Linux/OverriddenOperators.o \
...
DIST          = /opt/Qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		nbproject/nbproject/qt-Debug.pro src/CustomizableConsoleText.h \
		src/Env.h \
		src/OverriddenOperators.h \
		src/UnixConsoleText.h \
		src/WindowsConsoleText.h src/Env.cpp \
		src/OverriddenOperators.cpp \
		src/UnixConsoleText.cpp \
		src/WindowsConsoleText.cpp \
		src/main.cpp
QMAKE_TARGET  = universal
DESTDIR       = dist/Debug/GNU-Linux/#avoid trailing-slash linebreak
TARGET        = dist/Debug/GNU-Linux/universal
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/CustomizableConsoleText.h src/Env.h src/OverriddenOperators.h src/UnixConsoleText.h src/WindowsConsoleText.h $(DISTDIR)/
	$(COPY_FILE) --parents src/Env.cpp src/OverriddenOperators.cpp src/UnixConsoleText.cpp src/WindowsConsoleText.cpp src/main.cpp $(DISTDIR)/
...
build/Debug/GNU-Linux/Env.o: src/Env.cpp src/Env.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux/Env.o src/Env.cpp

build/Debug/GNU-Linux/OverriddenOperators.o: src/OverriddenOperators.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux/OverriddenOperators.o src/OverriddenOperators.cpp
