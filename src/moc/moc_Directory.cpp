...
const QMetaObjectExtraData Directory::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Directory::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Directory,
      qt_meta_data_Directory, &staticMetaObjectExtraData }
};
