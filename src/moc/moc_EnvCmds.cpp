...
static const char qt_meta_stringdata_EnvCmds[] = {
    "EnvCmds\0"
};
...
const QMetaObjectExtraData EnvCmds::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject EnvCmds::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_EnvCmds,
      qt_meta_data_EnvCmds, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &EnvCmds::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EnvCmds))
