...
struct qt_meta_stringdata_NewProjectGui_t {
    QByteArrayData data[7];
    char stringdata[110];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_NewProjectGui_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_NewProjectGui_t qt_meta_stringdata_NewProjectGui = {
    {
...
QT_MOC_LITERAL(6, 89, 19)
    ...
    "NewProjectGui\0handleBackBtnSlot\0\0"
...
const QMetaObject NewProjectGui::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NewProjectGui.data,
      qt_meta_data_NewProjectGui,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NewProjectGui.stringdata))
