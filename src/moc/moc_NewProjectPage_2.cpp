...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_NewProjectPage_2_t, stringdata) + ofs \
...
const QMetaObject NewProjectPage_2::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NewProjectPage_2.data,
      qt_meta_data_NewProjectPage_2,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NewProjectPage_2.stringdata))
