...
struct qt_meta_stringdata_NewProjectPage_4_t {
    QByteArrayData data[4];
    char stringdata[72];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_NewProjectPage_4_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_NewProjectPage_4_t qt_meta_stringdata_NewProjectPage_4 = {
    {
...
QT_MOC_LITERAL(3, 44, 26)
    ...
    "NewProjectPage_4\0handleAddToListBtnPtrSlot\0"
...
const QMetaObject NewProjectPage_4::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NewProjectPage_4.data,
      qt_meta_data_NewProjectPage_4,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NewProjectPage_4.stringdata))
