...
struct qt_meta_stringdata_PhysicalAttribLog_t {
    QByteArrayData data[1];
    char stringdata[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_PhysicalAttribLog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_PhysicalAttribLog_t qt_meta_stringdata_PhysicalAttribLog = {
    {
...
const QMetaObject PhysicalAttribLog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PhysicalAttribLog.data,
      qt_meta_data_PhysicalAttribLog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PhysicalAttribLog.stringdata))
