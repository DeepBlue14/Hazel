...
struct qt_meta_stringdata_RunGui_t {
    QByteArrayData data[7];
    char stringdata[103];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_RunGui_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_RunGui_t qt_meta_stringdata_RunGui = {
    {
...
QT_MOC_LITERAL(6, 82, 19)
    ...
    "RunGui\0handleBackBtnSlot\0\0handleNextBtnSlot\0"
    "handleFinishBtnSlot\0handleHelpBntSlot\0"
...
const QMetaObject RunGui::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RunGui.data,
      qt_meta_data_RunGui,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RunGui.stringdata))
