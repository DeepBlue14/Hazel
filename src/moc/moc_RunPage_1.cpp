...
struct qt_meta_stringdata_RunPage_1_t {
    QByteArrayData data[1];
    char stringdata[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_RunPage_1_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_RunPage_1_t qt_meta_stringdata_RunPage_1 = {
    {
...
const QMetaObject RunPage_1::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RunPage_1.data,
      qt_meta_data_RunPage_1,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RunPage_1.stringdata))
