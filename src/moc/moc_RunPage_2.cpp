...
struct qt_meta_stringdata_RunPage_2_t {
    QByteArrayData data[3];
    char stringdata[44];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_RunPage_2_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_RunPage_2_t qt_meta_stringdata_RunPage_2 = {
    {
QT_MOC_LITERAL(0, 0, 9),
QT_MOC_LITERAL(1, 10, 31),
QT_MOC_LITERAL(2, 42, 0)
    },
    "RunPage_2\0handleSelectLaunchFilePbPtrSlot\0"
    "\0"
};
...
const QMetaObject RunPage_2::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RunPage_2.data,
      qt_meta_data_RunPage_2,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RunPage_2.stringdata))
