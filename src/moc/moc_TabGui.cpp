...
struct qt_meta_stringdata_TabGui_t {
    QByteArrayData data[4];
    char stringdata[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TabGui_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TabGui_t qt_meta_stringdata_TabGui = {
    {
...
QT_MOC_LITERAL(3, 27, 5)
    ...
    "TabGui\0handleCloseTabSlot\0\0index\0"
};
...
const QMetaObject TabGui::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TabGui.data,
      qt_meta_data_TabGui,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TabGui.stringdata))
