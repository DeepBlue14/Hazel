...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Nov 30 00:03:58 2015
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/OutputUi1.0.0/ && $(COPY_FILE) --parents src/BuildDisplay.h src/DebugGui.h src/DebugToolbar.h src/HtmlColorFactory.h src/OutputToolbar.h src/OutputUi.h src/RosEnv.h src/RunDisplay.h src/RunToolbar.h build/Debug/GNU-Linux-x86/OutputUi1.0.0/ && $(COPY_FILE) --parents src/BuildDisplay.cpp src/DebugGui.cpp src/DebugToolbar.cpp src/HtmlColorFactory.cpp src/OutputToolbar.cpp src/OutputUi.cpp src/RosEnv.cpp src/RunDisplay.cpp src/RunToolbar.cpp src/main.cpp build/Debug/GNU-Linux-x86/OutputUi1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/OutputUi1.0.0` && $(TAR) OutputUi1.0.0.tar OutputUi1.0.0 && $(COMPRESS) OutputUi1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/OutputUi1.0.0`/OutputUi1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/OutputUi1.0.0
...
compiler_moc_header_make_all: src/moc/moc_BuildDisplay.cpp src/moc/moc_DebugGui.cpp src/moc/moc_DebugToolbar.cpp src/moc/moc_OutputToolbar.cpp src/moc/moc_OutputUi.cpp src/moc/moc_RunDisplay.cpp src/moc/moc_RunToolbar.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) src/moc/moc_BuildDisplay.cpp src/moc/moc_DebugGui.cpp src/moc/moc_DebugToolbar.cpp src/moc/moc_OutputToolbar.cpp src/moc/moc_OutputUi.cpp src/moc/moc_RunDisplay.cpp src/moc/moc_RunToolbar.cpp
src/moc/moc_BuildDisplay.cpp: src/RunDisplay.h \
		src/RunToolbar.h \
		src/RosEnv.h \
		src/BuildDisplay.h
...
src/moc/moc_RunDisplay.cpp: src/RunToolbar.h \
		src/RosEnv.h \
		src/RunDisplay.h
