...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Dec 4 16:30:40 2015
...
OBJECTS       = build/Debug/GNU-Linux-x86/AbstractOutputToolBar.o \
		...
		build/Debug/GNU-Linux-x86/SigTextToolBar.o \
		build/Debug/GNU-Linux-x86/SigWindow.o \
		...
		build/Debug/GNU-Linux-x86/moc_SigTextToolBar.o \
		build/Debug/GNU-Linux-x86/moc_SigWindow.o
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/OutputUi1.0.0/ && $(COPY_FILE) --parents src/AbstractOutputToolBar.h src/BuildDisplay.h src/DebugGui.h src/DebugToolbar.h src/HtmlColorFactory.h src/OutputToolBar.h src/OutputUi.h src/RosEnv.h src/RunDisplay.h src/RunToolBar.h src/SigTextEdit.h src/SigTextToolBar.h src/SigWindow.h build/Debug/GNU-Linux-x86/OutputUi1.0.0/ && $(COPY_FILE) --parents src/AbstractOutputToolBar.cpp src/BuildDisplay.cpp src/DebugGui.cpp src/DebugToolbar.cpp src/HtmlColorFactory.cpp src/OutputToolBar.cpp src/OutputUi.cpp src/RosEnv.cpp src/RunDisplay.cpp src/RunToolBar.cpp src/SigTextEdit.cpp src/SigTextToolBar.cpp src/SigWindow.cpp src/main.cpp build/Debug/GNU-Linux-x86/OutputUi1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/OutputUi1.0.0` && $(TAR) OutputUi1.0.0.tar OutputUi1.0.0 && $(COMPRESS) OutputUi1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/OutputUi1.0.0`/OutputUi1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/OutputUi1.0.0
...
build/Debug/GNU-Linux-x86/SigTextToolBar.o: src/SigTextToolBar.cpp src/SigTextToolBar.h \
		src/AbstractOutputToolBar.h \
		src/RosEnv.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/SigTextToolBar.o src/SigTextToolBar.cpp

build/Debug/GNU-Linux-x86/SigWindow.o: src/SigWindow.cpp src/SigWindow.h \
		src/SigTextEdit.h \
		src/RunToolBar.h \
		src/AbstractOutputToolBar.h \
		src/RosEnv.h \
		src/SigTextToolBar.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/SigWindow.o src/SigWindow.cpp
...
build/Debug/GNU-Linux-x86/moc_SigTextToolBar.o: src/moc/moc_SigTextToolBar.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/moc_SigTextToolBar.o src/moc/moc_SigTextToolBar.cpp

build/Debug/GNU-Linux-x86/moc_SigWindow.o: src/moc/moc_SigWindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/moc_SigWindow.o src/moc/moc_SigWindow.cpp
