...
{
    startActPtr = new QAction(QIcon(RosEnv::imagesInstallLoc + "placeholder.png"), tr("&New File"), this);
    ...
    stopActPtr = new QAction(QIcon(RosEnv::imagesInstallLoc + "placeholder.png"), tr("&New File"), this);
    ...
    pauseActPtr = new QAction(QIcon(RosEnv::imagesInstallLoc + "placeholder.png"), tr("&New File"), this);
    ...
    stepIntoActPtr = new QAction(QIcon(RosEnv::imagesInstallLoc + "placeholder.png"), tr("&New File"), this);
    ...
    stepOverActPtr = new QAction(QIcon(RosEnv::imagesInstallLoc + "placeholder.png"), tr("&New File"), this);
